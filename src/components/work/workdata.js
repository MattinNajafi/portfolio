const workData = [
  {
    id: 1,
    header: "Jannes Tapeter",
    description:
      "Final project together with a group selected by the school in dynamic web development, used mongodb as backend",
  },
  {
    id: 2,
    header: "ColorSplat",
    description: "Final project with a group of 5 in JavaScript",
  },
  {
    id: 3,
    header: "M&M Weather",
